...
L2=0.22 #[m] Long. barra 2 (entrada)
L3=0.72 #[m] Long. barra 3
L4=0.92 #[m] Long. barra 4
Z1=0.62 #[m] Long. de A a P
beta=32.00 #[grados] Ángulo de AP respecto a barra 3
...
#Ángulo de entrada
theta2i=1 #[grados] Ángulo entrada inicial
theta2f=359 #[grados] Ángulo entrada final
N=int(359) #Número de posiciones a analizar
w2=1.3 #[rad/s] Velocidad angular barra 2
...
plt.plot([0,Ax[n]],[0,Ay[n]],'b')
plt.plot([Ax[n],Px[n]],[Ay[n],Py[n]],'b')
plt.plot([Px[n],Bx[n]],[Py[n],By[n]],'b')
plt.plot([Ax[n],Bx[n]],[Ay[n],By[n]],'b')
plt.plot([Bx[n],O2x],[By[n],O2y],'b')
...
plt.xlabel('Negro: posición inicial - Azul: pos. media - Magenta: pos. final')
